const features = [
  {
    ...
    description:
      'Triggers instantly when someone tries to open the window from outside — even just a crack.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-sky-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    title: 'Detects impact and glass vibration',
    description:
      'Picks up knocking, forced entry attempts, or any unusual vibration on the glass.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-sky-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    title: 'Wakes you up immediately',
    description:
      'Loud alarm scares off intruders. Push notification on your phone — even if you\'re in the next room.',
  },
];
    ...
    <section className="py-20 px-4 sm:px-6 bg-slate-50">
      <div className="max-w-5xl mx-auto">
        ...
        <p className="text-slate-500 text-center mb-14 max-w-2xl mx-auto">
          PeekProof combines multiple sensors in a pocket-sized device — so you know the moment someone approaches your window from outside.
        </p>
