const problems = [
  {
    ...
    title: 'Kids sleeping in another room',
    description:
      'On holiday, children often sleep in a separate hotel or Airbnb room. You can\'t always be next to the window.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-amber-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    description:
      'Ground-floor hotel rooms and Airbnbs have windows that are easily accessible from outside.',
  },
  {
    icon: (
      <svg className="w-8 h-8 text-amber-500" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
    ...
    title: 'Unknown locks and latches',
    description:
      'Every accommodation has different window hardware. You never know if that lock actually holds.',
  },
];
